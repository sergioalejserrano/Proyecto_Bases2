...
#Region "Borrar Vehiculo"
    Function SP_BORRAR_VEHICULO(ByVal vehiculo As BEUVehiculo) As Boolean
        ...
        Try
            ...
            Try
                resgistrosActualizados = cmd.ExecuteNonQuery() 'Se solicita el # de filas afectadas.
                MsgBox("Vehiculo borrado correctamente.", MsgBoxStyle.Information)
            Catch ex As Exception
                MsgBox("No se pudo borrar el vehiculo", MsgBoxStyle.Critical)
                Throw New Exception("Vehiculo no se borro")
