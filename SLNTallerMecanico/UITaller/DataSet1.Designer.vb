...
Partial Public Class DataSet1
    ...
    Partial Public Class EMPLEADODataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")>  _
        Public Overloads Function AddEMPLEADORow(ByVal ID_EMPLEADO As Decimal, ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal TIPO As String, ByVal ESTADO As String, ByVal CONTRASENA As String) As EMPLEADORow
            Dim rowEMPLEADORow As EMPLEADORow = CType(Me.NewRow,EMPLEADORow)
            Dim columnValuesArray() As Object = New Object() {ID_EMPLEADO, NOMBRE, APELLIDO, TIPO, ESTADO, CONTRASENA}
    ...
    Partial Public Class EMPLEADOTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.DeleteCommand.CommandText = "DELETE FROM ""TALLER"".""EMPLEADO"" WHERE ((""ID_EMPLEADO"" = :Original_ID_EMPLEADO) AN"& _ 
                ...
                "L) OR (""APELLIDO"" = :Original_APELLIDO)) AND (""TIPO"" = :Original_TIPO) AND (""EST"& _ 
                "ADO"" = :Original_ESTADO) AND (""CONTRASENA"" = :Original_CONTRASENA))"
            Me._adapter.DeleteCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_ID_EMPLEADO", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "ID_EMPLEADO", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.DeleteCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_ESTADO", Global.System.Data.OracleClient.OracleType.[Char], 0, Global.System.Data.ParameterDirection.Input, "ESTADO", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO ""TALLER"".""EMPLEADO"" (""ID_EMPLEADO"", ""NOMBRE"", ""APELLIDO"", ""TIPO"", ""ES"& _ 
                "TADO"", ""CONTRASENA"") VALUES (:ID_EMPLEADO, :NOMBRE, :APELLIDO, :TIPO, :ESTADO, :"& _ 
                "CONTRASENA)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("ID_EMPLEADO", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "ID_EMPLEADO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.InsertCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("ESTADO", Global.System.Data.OracleClient.OracleType.[Char], 0, Global.System.Data.ParameterDirection.Input, "ESTADO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE ""TALLER"".""EMPLEADO"" SET ""ID_EMPLEADO"" = :ID_EMPLEADO, ""NOMBRE"" = :NOMBRE, "& _ 
                """APELLIDO"" = :APELLIDO, ""TIPO"" = :TIPO, ""ESTADO"" = :ESTADO, ""CONTRASENA"" = :CONT"& _ 
                "RASENA WHERE ((""ID_EMPLEADO"" = :Original_ID_EMPLEADO) AND (""NOMBRE"" = :Original_"& _ 
                "NOMBRE) AND ((:IsNull_APELLIDO = 1 AND ""APELLIDO"" IS NULL) OR (""APELLIDO"" = :Ori"& _ 
                "ginal_APELLIDO)) AND (""TIPO"" = :Original_TIPO) AND (""ESTADO"" = :Original_ESTADO)"& _ 
                " AND (""CONTRASENA"" = :Original_CONTRASENA))"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("ID_EMPLEADO", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "ID_EMPLEADO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("ESTADO", Global.System.Data.OracleClient.OracleType.[Char], 0, Global.System.Data.ParameterDirection.Input, "ESTADO", Global.System.Data.DataRowVersion.Current, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_ID_EMPLEADO", Global.System.Data.OracleClient.OracleType.Number, 0, Global.System.Data.ParameterDirection.Input, "ID_EMPLEADO", Global.System.Data.DataRowVersion.Original, false, Nothing))
            ...
            Me._adapter.UpdateCommand.Parameters.Add(New Global.System.Data.OracleClient.OracleParameter("Original_ESTADO", Global.System.Data.OracleClient.OracleType.[Char], 0, Global.System.Data.ParameterDirection.Input, "ESTADO", Global.System.Data.DataRowVersion.Original, false, Nothing))
        ...
        Private Sub InitCommandCollection()
            ...
            Me._commandCollection(0).CommandText = "SELECT ID_EMPLEADO, NOMBRE, APELLIDO, TIPO, ESTADO, CONTRASENA FROM TALLER.EMPLEA"& _ 
                "DO"
        ...
        Public Overloads Overridable Function Delete(ByVal Original_ID_EMPLEADO As Decimal, ByVal Original_NOMBRE As String, ByVal Original_APELLIDO As String, ByVal Original_TIPO As String, ByVal Original_ESTADO As String, ByVal Original_CONTRASENA As String) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal ID_EMPLEADO As Decimal, ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal TIPO As String, ByVal ESTADO As String, ByVal CONTRASENA As String) As Integer
        ...
        Public Overloads Overridable Function Update(ByVal ID_EMPLEADO As Decimal, ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal TIPO As String, ByVal ESTADO As String, ByVal CONTRASENA As String, ByVal Original_ID_EMPLEADO As Decimal, ByVal Original_NOMBRE As String, ByVal Original_APELLIDO As String, ByVal Original_TIPO As String, ByVal Original_ESTADO As String, ByVal Original_CONTRASENA As String) As Integer
            ...
            If (Original_CONTRASENA Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_CONTRASENA")
            Else
                Me.Adapter.UpdateCommand.Parameters(12).Value = CType(Original_CONTRASENA,String)
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal NOMBRE As String, ByVal APELLIDO As String, ByVal TIPO As String, ByVal ESTADO As String, ByVal CONTRASENA As String, ByVal Original_ID_EMPLEADO As Decimal, ByVal Original_NOMBRE As String, ByVal Original_APELLIDO As String, ByVal Original_TIPO As String, ByVal Original_ESTADO As String, ByVal Original_CONTRASENA As String) As Integer
            Return Me.Update(Original_ID_EMPLEADO, NOMBRE, APELLIDO, TIPO, ESTADO, CONTRASENA, Original_ID_EMPLEADO, Original_NOMBRE, Original_APELLIDO, Original_TIPO, Original_ESTADO, Original_CONTRASENA)
        End Function
    End Class
